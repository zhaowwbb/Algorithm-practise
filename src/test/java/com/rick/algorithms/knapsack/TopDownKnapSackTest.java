...
public class TopDownKnapSackTest extends AbstractKnapSackTest {
	private TopDownKnapSack _instance = new TopDownKnapSack();
	
	protected WeightKnapSack createInstance() {
		return new TopDownKnapSack();
	}
...
//		System.out.println("TopDownKnapSack case 3 spend:" + usedTime);
//		
//		printList(list);			
